...
U_NA,              &kp AMPS,          &kp ASTR,          &kp LPAR,          &kp DQT,           &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_NA,              &kp DOLLAR,        &kp PRCNT,         &kp CARET,         U_NA,              &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_NA,              &kp EXCL,          &kp AT,            &kp HASH,          U_NA,              &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
