...
&kp AMPS,          &kp ASTR,          &kp LPAR,          &kp DQT,           U_NA,              &kp APOS,          &kp PIPE,          &kp EQUAL,         &kp MINUS,         U_NA,              \
&kp DOLLAR,        &kp PRCNT,         &kp CARET,         U_NA,              U_NA,              U_NA,              &kp BSLH,          &kp GRAVE,         &kp COLON,         U_NA,              \
&kp EXCL,          &kp AT,            &kp HASH,          U_NA,              U_NA,              U_NA,              &kp LT,            &kp GT,            &kp SLASH,         U_NA,              \
